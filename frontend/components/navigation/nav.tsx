...
export const SECONDARY_NAV: NavItem[] = [
  ...
  { href: "/errors", label: "Errors", icon: AlertOctagon, later: true },
  { href: "/learning", label: "Learning", icon: GraduationCap, later: true },
  { href: "/growth", label: "Growth", icon: Sprout, later: true },
